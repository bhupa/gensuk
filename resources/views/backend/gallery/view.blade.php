                            ...
                            @foreach($galleries as $key=>$item)
                                <tr id="item-{{$item->id}}">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('gallery-image.index', $item->slug)}}" class="edit-modal btn btn-primary btn-circle btn-sm"
                                           data-info="">
                                            <i class="fas fa-images"></i>
                                        </a>
                                        <a href="{{route('gallerys.edit', $item->slug)}}" class="edit-modal btn btn-info btn-circle btn-sm"
                                           data-info="">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        {{-- @endif --}}
                                        {{-- @if(auth()->user()->can('delete-banner')) --}}
                                        <a href="javascript:void(0)" class="delete-gallerys btn btn-danger btn-circle btn-sm"
                                           data-type="{{$item->id}}">
