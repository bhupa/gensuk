                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('blog_categories.create')}}"> Add Category </a></li>
                            ...
                            @foreach($blogCategories as $key=>$item)
                                <tr id="item-{{$item->id}}">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('blog_categories.edit', $item->slug)}}" class="edit-modal btn btn-info btn-circle btn-sm"
                                           data-info="">
            ...
            <script>
                $(document).ready( function () {
                    ...
                    $('#table').on('click','.delete-content',function(event){
                        ...
                        var url = baseUrl+"/blog_categories/"+id;
                        swal({
                            title: 'Are you sure?',
                            ...
                            if (result.value) {
                                $.ajax({
                                    ...
                                    success: function (response) {
                                        ...
                                        if (response.blogCategories.is_active == 1) {
