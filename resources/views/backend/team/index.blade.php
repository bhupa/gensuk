                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('teams.create')}}"> Add Executive Committee</a></li>
                            ...
                            @foreach($teams as $key=>$item)
                                <tr id="item-{{$key+1}}">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('teams.edit', $item->slug)}}" class="edit-modal btn btn-info btn-circle btn-sm"
                                           data-info="">
...
@section('js_script')
    <script>
        $(document).ready( function () {
            ...
            $('#table').on('click','.delete-teams',function(event){
                event.preventDefault();
                $object = $(this);
                var id  = $(this).attr('data-type');
                var url = baseUrl+"/teams/"+id;
                swal({
                    title: 'Are you sure?',
