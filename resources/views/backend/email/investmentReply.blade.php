...
<table class="body-wrap" bgcolor="#f6f6f6">
    ...
    <!-- content -->
    <tr class="container" bgcolor="#FFFFFF"><br><strong>Dear {{$data['name']}} , </strong></tr>
    <tr class="container" bgcolor="#FFFFFF"><td>Subject:<br>Your intrested to invest in {!! $data->project->title !!}</td></tr>
