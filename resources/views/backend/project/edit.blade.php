                ...
                <div class="row justify-content-center">
                    <div class="col-8 ">
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            {!! Form::model($projects,['route'=>['projects.update',$projects->id],'class'=>'needs-validation','method'=>'PUT','enctype'=>   "multipart/form-data"])!!}

                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Title</label>
                                    <input type="text" class="form-control" name="title" placeholder="Enter Title" value="{{$projects->title}}">
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"  name="investors" value="{{$projects->investors}}"  @if($projects->investors == '1') checked @endif>
                                        <label for="exampleInputEmail1">Investors </label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="cover edit-cover" >
                                        <a href="#">
                                            @if(file_exists('storage/'.$projects->image) && $projects->image != '')
                                ...
                                <div class="form-group">
                                    ...
                                    {{Form::textarea('short_description',$projects->short_description,['class'=>'form-control','id'=>'short_description'])}}
                                ...
                                <div class="form-group">
                                    ...
                                    {{Form::textarea('description',$projects->description,['class'=>'form-control editor','id'=>'description'])}}
                                    {{--                                        <textarea class="form-control" rows="3" placeholder="Enter ..." style="margin-top: 0px; margin-bottom: 0px; height: 115px;"></textarea>--}}
